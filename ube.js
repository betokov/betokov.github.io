      ...
      return _createClass(EmailOptin, [{
        ...
        value: function () {
          var _run = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(key, state, cb) {
            var _state$config;
            var options, target, formKey, emailOptinName, isAllowRegBeforeOptin, categoryPrefix, MAX_RESEND_COUNT, sessionKey, resendCounter, checkAvStatusAndCallback, _state$user;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                      ...
                      var _onSubmissionSuccess = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(submissionId, userId, result) {
                        ...
                        return _regeneratorRuntime().wrap(function _callee$(_context) {
                          while (1) switch (_context.prev = _context.next) {
                            case 0:
                              block = {};
                              sessionKey = (_result$data = result.data) === null || _result$data === void 0 ? void 0 : _result$data.sessionKey;
                              additionalState = {
                                sessionKey: sessionKey
                              };
                              _context.t0 = result.event;
                              _context.next = _context.t0 === "loginSuccess" ? 6 : _context.t0 === "alreadyVerified" ? 12 : _context.t0 === "registered" ? 18 : _context.t0 === "email-changed" ? 23 : _context.t0 === "close" ? 25 : 27;
                              break;
                            case 6:
                              _context.next = 8;
                ...
                handle_form = function handle_form() {
                    ...
                    $__default["default"].ajax({
                      ...
                      error: function error(xhr, resp, text) {
                        ...
                        if (/-reg$/.test(path)) {
                          ...
                          var _action3;
                          if (remainingAttemptsCount) {
                            updatePhoneTypeActions(_phoneTypeActions2, " - attempts_left: ".concat(remainingAttemptsCount));
                          } else {
                            updatePhoneTypeActions(_phoneTypeActions2, ' - reason: technical');
                          }
                          if (isMBEPForm && !isP1Domain()) {
                            _action3 = 'form - phone_code - reason: technical';
                          } else if (preferredMethod) {
                      ...
                      function submissionSuccess(result) {
                        ...
                        if (name.includes('phone-send')) {
                          ...
                          if (isMBEPForm && !isP1Domain()) {
                            ...
                            _action4 = phoneTypeActions[preferredMethod];
                          } else if (phoneConfirmationType) {
                            _action4 = phoneTypeActions[phoneConfirmationType];
                          }
                          ...
                          if (isMBEPForm && !isP1Domain()) {
                            _action5 = "form - phone - (".concat(status, ")");
                          } else if (preferredMethod) {
                            _action5 = _phoneTypeActions3[preferredMethod];
                          } else if (phoneConfirmationType) {
                            _action5 = _phoneTypeActions3[phoneConfirmationType];
                          }
                          ...
                          var _action6 = 'form - registration';
                          gaSkipEmailOptin(_category9, _action6);
                        ...
                        if (ga_name === 'LoginRemind') gaPush(categoryPrefix + 'auth_resetPassword_success', 'form - resetPassword');else if (ga_name === 'Login') {
                          ...
                          gaPush(categoryPrefix + 'auth_password_success', "form - password - ".concat(_action8));
                        }
                  ...
                  function onFormSubmit(part) {
                    ...
                    validateAllFields(function () {
                      ...
                      if (/-reg$/.test(path)) {
                        ...
                        var _action9 = 'send - form - 2optin';
                        gaSkipEmailOptin(_category12, _action9);
                        gaPush(_category12, _action9);
                        ga_name = "2OPTIN";
                      } else if (/av$/.test(path)) {
                        action_path = "/esb/" + path + "/submission";
                        ga_name = "AV";
                        ...
                        if (isMBEPForm && !isP1Domain()) {
                          _action10 = 'send - form - phone_code';
                        } else if (preferredMethod) {
                          _action10 = phoneTypeActions[preferredMethod];
                        } else if (phoneConfirmationType) {
                          _action10 = phoneTypeActions[phoneConfirmationType];
                        }
                        ...
                        var _action11;
                        if (isMBEPForm && !isP1Domain()) {
                          _action11 = 'send - form - phone_number';
                        } else if (preferredMethod) {
                          _action11 = _phoneTypeActions4[preferredMethod];
                        } else if (phoneConfirmationType) {
                          var _category15 = isQRDomain() ? 'dl_qr_' : 'dl_auth_';
                          _action11 = _phoneTypeActions4[phoneConfirmationType];
                  ...
                  container.off("click", ".ube-trigger-event").on("click", ".ube-trigger-event", /*#__PURE__*/function () {
                    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
                      var event, repeat, cabinetUrl, preferredMethod, category, action, phoneTypeActions, data, formData, _phoneTypeActions5, key, finalUrl;
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) switch (_context.prev = _context.next) {
                          case 0:
                            e.preventDefault();
                          ...
                          case 3:
                            ...
                            if (/-phone-check$/.test(path)) {
                              ...
                              if (preferredMethod) {
                                action = _phoneTypeActions5[preferredMethod];
                              } else if (phoneConfirmationType) {
                                action = _phoneTypeActions5[phoneConfirmationType];
                              }
                              gaPush("".concat(category, "phone_process"), action);
                            }
                            if (useCoreCRM) {
