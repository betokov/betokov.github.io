    ...
    */
    ...
    $__default["default"].fn.ube = function (url, options) {
      ...
      function initializeFormByConfig(json) {
        ...
        var categoryPrefix = isQRForm ? 'dl_qr_' : 'dl_';
        var phoneSendMethod = $__default["default"]('.ube-phone-send-preferredMethod').data('method');
        ...
        var handle_form = function handle_form() {
          ...
          if (/-reg$/.test(path)) {
            ...
            if (phoneSendMethod) {
              if (phoneSendMethod === 'telegram') {
                gaPush(_category3, "form - phone_telegram_push");
              } else {
                gaPush(_category3, "form - phone_sms_code");
              }
            } else {
