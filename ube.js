            ...
            onFormLoad: function onFormLoad() {
              ...
              if (preferredMethod) {
                if (preferredMethod === 'authCall' && phoneToCall) {
                  ...
                  $__default["default"]('.ube-phone-check-auth-call').attr('href', "tel:+".concat(phoneToCall)).show();
                }
              ...
              case 46:
                ...
                handle_form = function handle_form() {
                  ...
                  if (/-reg$/.test(path)) {
                    ...
                    var _category4 = isQRDomain() ? 'dl_qr_' : 'dl_auth_';
                    action_path = "/esb/" + path + "/submission";
                    ...
                    if (!preferredMethod) {
                      if (phoneConfirmationType === 'telegram') {
                        gaPush("".concat(_category4, "phone_start"), "form - phone_telegram_push");
                      } else if (phoneConfirmationType === 'sms') {
                        gaPush("".concat(_category4, "phone_start"), "form - phone_sms_code");
                      } else if (phoneConfirmationType === 'flashingCall') {
                        gaPush("".concat(_category4, "phone_start"), "form - phone_call_code");
                      }
                    }
                    ...
                    $__default["default"].ajax({
                      ...
                      error: function error(xhr, resp, text) {
                        ...
                        if (/-reg$/.test(path)) {
                          ...
                          var _category5 = isQRForm ? 'dl_qr_registration_fail' : 'dl_auth_registration_fail';
                          gaPush(_category5, "form - registration - reason: technical");
                          if (isMBEPForm) {
                      ...
                      function submissionSuccess(result) {
                        ...
                        if (name.includes('phone-send')) {
                          var _category8 = isQRForm ? 'dl_qr_phone_process' : 'dl_auth_phone_process';
                          ...
                          var _category9 = isQRForm ? 'dl_qr_phone_success' : 'dl_auth_phone_success';
                          ...
                          var _category10 = isQRForm ? 'dl_qr_registration_success' : 'dl_auth_registration_success';
                          var _action7 = 'form - registration';
                          gaSkipEmailOptin(_category10, _action7);
                          gaPush(_category10, _action7);
                          ...
                          var _category11 = categoryPrefix + '2optin_success';
                          var _action8 = 'form - 2optin';
                          gaSkipEmailOptin(_category11, _action8);
                          gaPush(_category11, _action8);
                  ...
                  function onFormSubmit(part) {
                    ...
                    validateAllFields(function () {
                      ...
                      validationState = {};
                      if (/-reg$/.test(path)) {
                        var _category12 = isQRForm ? 'dl_qr_registration_process' : 'dl_auth_registration_process';
                        gaPush(_category12, 'send - form - registration');
                      } else if (/optin$/.test(path)) {
                        actionPathOptin({
                          path: path,
                          configKey: configKey,
                        ...
                        var _category13 = categoryPrefix + '2optin_process';
                        var _action10 = 'send - form - 2optin';
                        gaSkipEmailOptin(_category13, _action10);
                        gaPush(_category13, _action10);
                        ga_name = "2OPTIN";
                      } else if (/av$/.test(path)) {
                        action_path = "/esb/" + path + "/submission";
                        ga_name = "AV";
