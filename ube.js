            ...
            case 0:
              _messageHandle = function _messageHandle3() {
                _messageHandle = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
                  var _getParameters, _getParameters2, utmCampaign, utmSource, utmContent, utmMedium, utmTerm, token, uuid, response, result;
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
            ...
            onFormLoad: function onFormLoad(_ref) {
              ...
              methodBtn.on('click', function (e) {
                ...
                if (method === 'telegram' && alternativeCaptchaEnabled && alternativeGrecaptcha) {
                  ...
                  gaPush("".concat(category, "phone_process"), "click - phone_".concat(method, "_push - screen_fork"));
                  gaPush("".concat(category, "phone_start"), "form - phone_telegram_push");
                } else if (method === 'sms') {
                  gaPush("".concat(category, "phone_process"), "click - phone_".concat(method, "_code - screen_fork"));
          ...
          if (key && gaFieldSet[key] !== false) {
            ...
            if (/-phone-send$/.test(name)) {
              ...
              var _phoneTypeActions = {
                telegram: "telegram_push - form - phone_telegram_push - reason: ".concat(description),
                sms: "sms_code - form - phone_sms_code - reason: ".concat(description)
              };
              var _action;
              if (remainingAttemptsCount) {
                _phoneTypeActions.telegram = "telegram_push - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount, " - reason: ").concat(description);
                _phoneTypeActions.sms = "sms_code - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount, " - reason: ").concat(description);
              }
              if (isMBEPForm) {
            ...
            $__default["default"].ajax({
              ...
              error: function error(xhr, resp, text) {
                ...
                if (/-reg$/.test(path)) {
                  ...
                  var action;
                  if (isP1Domain()) {
                    gaPush('dl_auth_phone', 'fail - phone', 'technical');
                  } else if (isMBEPForm) {
                  ...
                  gaPush(_category4, action);
                } else if (/-phone-send$/.test(path)) {
                  action_path = "/esb/" + path + "/submission";
                  var _category5 = isQRForm ? 'dl_qr_phone_fail' : 'dl_auth_phone_fail';
                  var _phoneTypeActions2 = {
                    telegram: 'telegram_push - form - phone_telegram_push - reason: technical',
                    sms: 'sms_code - form - phone_sms_code - reason: technical'
                  };
                  var _action2;
                  if (remainingAttemptsCount) {
                    _phoneTypeActions2.telegram = "telegram_push - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount, " - reason: technical");
                    _phoneTypeActions2.sms = "sms_code - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount, " - reason: technical");
                  }
                  if (isMBEPForm) {
                    _action2 = 'form - phone_code - reason: technical';
                  } else if (preferredMethod) {
                    _action2 = _phoneTypeActions2[preferredMethod];
                  } else if (phoneConfirmationType) {
                    _action2 = _phoneTypeActions2[phoneConfirmationType];
                  }
              ...
              function submissionSuccess(result) {
                ...
                if (name.includes('phone-send')) {
                  ...
                  var _action3;
                  if (remainingAttemptsCount) {
                    _phoneTypeActions3.telegram = "".concat(_phoneTypeActions3["telegram"], " - attempts_left: ").concat(remainingAttemptsCount);
                    _phoneTypeActions3.sms = "".concat(_phoneTypeActions3["sms"], " - attempts_left: ").concat(remainingAttemptsCount);
                  }
                  if (isMBEPForm) {
                    _action3 = "form - phone - (".concat(status, ")");
                  } else if (preferredMethod) {
                    _action3 = _phoneTypeActions3[preferredMethod];
                  } else if (phoneConfirmationType) {
                    _action3 = _phoneTypeActions3[phoneConfirmationType];
                  }
                  ...
                  gaPush(_category8, 'form - registration');
          ...
          function onFormSubmit(part) {
            ...
            validateAllFields(function () {
              ...
              if (/-reg$/.test(path)) {
                ...
                var action;
                if (remainingAttemptsCount) {
                  phoneTypeActions.telegram = "send - telegram_push - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount);
                  phoneTypeActions.sms = "send - sms_code - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount);
                }
                if (isMBEPForm) {
          ...
          container.off("click", ".ube-trigger-event").on("click", ".ube-trigger-event", function (e) {
            ...
            if (event == "resendCode" || event == "resendPhoneCode" || event == "resendEmailCode") {
              var _phoneTypeActions5 = {
                ...
                sms: 'telegram_push - send_again - form - phone_telegram_push'
              };
              if (remainingAttemptsCount) {
                _phoneTypeActions5.telegram = "telegram_push - send_again - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount);
                _phoneTypeActions5.sms = "sms_code - send_again - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount);
              }
              if (preferredMethod) {
