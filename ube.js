          ...
          var xhrRequest = $__default["default"].ajax({
            ...
            error: function error(err) {
              if (priorityFunction) {
                ...
                gaPush("dl_qr_av_fr_fail", "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount), " - reason: technical"));
              }
            ...
            success: function success(data) {
              if (priorityFunction) {
                ...
                if (data.isAdult) {
                  ...
                  gaPush("dl_qr_av_fr_success", "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount)));
                  ...
                  gaPush("dl_qr_av_fr_fail", "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount)));
                  if (tryCount < 2) {
                    tryCount++;
                    fcm.reload();
              ...
              if (data) {
                ...
                if (status_code === "SUCCESS" && !window.bad) {
                  ...
                  if (priorityFunction) {
                    if (type === 'auto') fcm.unmount();
                    onError("limit", data);
                    gaPush("dl_qr_av_fr_fail", "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount, error_message), " - reason: ").concat(error_message));
                  }
                  ...
                  if (priorityFunction) {
                    ...
                    if (errors_detail) {
                      ...
                      gaPush("dl_qr_av_fr_fail", "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount, _error_message), " - reason: ").concat(_error_message));
                    }
                    if (tryCount < 2) {
      ...
      $__default["default"].fn.ubeFace = function (name, options) {
        ...
        function initializeFaceCapture(_token, _tokenUrl) {
          ...
          function sendBlobToServer() {
            ...
            gaPush("dl_qr_av_fr_process", "send - form - fr_".concat(faceState.type, " - ").concat(label));
          ...
          function renderCameraCapture() {
            ...
            var onFaceError = function onFaceError(err) {
              ...
              gaPush("dl_qr_av_fr_process", "start - form - fr_upload - reason: ".concat(errLabel, " - ").concat(label));
            ...
            var onReadyForCaptureFace = function onReadyForCaptureFace() {
              !$__default["default"].ube.host.includes('test') && toggleLoader(false);
              var label = tryCount === 1 ? 'first' : 'second';
              gaPush("dl_qr_av_fr_process", "start - form - fr_auto - " + label);
