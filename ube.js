            ...
            success: function success(data) {
              if (priorityFunction) {
                ...
                if (data.isAdult) {
                  ...
                  setSessionData(result.data, null, faceState === null || faceState === void 0 || (_faceState$options = faceState.options) === null || _faceState$options === void 0 ? void 0 : _faceState$options.onSubmissionSuccess);
                } else {
                  if (tryCount < 2) {
                    tryCount++;
                    fcm.reload();
      ...
      $__default["default"].fn.ubeFace = function (name, options) {
        ...
        function initializeFaceCapture(_token, _tokenUrl) {
          ...
          function sendBlobToServer() {
            ...
            gaPush("dl_qr_av_fr_process", "send - form - fr_".concat(faceState.type));
