            ...
            $__default["default"].ajax({
              ...
              function submissionSuccess(result) {
                ...
                if (name.includes('phone-send')) {
                  ...
                  var _action3;
                  if (hasPreferredMethodContainer) {
                    _action3 = ubeSession('preferredMethod') === 'telegram' ? "form - phone_telegram_push - (".concat(result.event === 'loginSuccess' ? 'in_base' : 'not_in_base', ")") : "form - phone - (".concat(result.event === 'loginSuccess' ? 'in_base' : 'not_in_base', ")");
                  } else {
