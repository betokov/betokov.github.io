        ...
        function initializeFaceCapture(_token, _tokenUrl) {
          ...
          function renderCameraCapture() {
            ...
            var onReadyForCaptureFace = function onReadyForCaptureFace() {
              ...
              var seconds = 10;
              var container = "<div class=\"ube-face-timer\"><h2>\u041F\u0440\u043E\u0432\u0435\u0440\u043A\u0430 \u0432\u043E\u0437\u0440\u0430\u0441\u0442\u0430</h2> <br> \u043E\u0441\u0442\u0430\u043B\u043E\u0441\u044C <span class=\"face-timer__seconds\"></span></div>";
              $__default["default"]('.ube-camera-render').append(container);
              var secondsContainer = $__default["default"]('.face-timer__seconds');
              $__default["default"](secondsContainer).text(seconds);
              var timer = setInterval(function () {
                if (seconds <= 0) {
                  clearInterval(timer);
                  $__default["default"]('.ube-face-timer').hide();
                }
                seconds -= 1;
                $__default["default"](secondsContainer).text(seconds);
              }, 1000);
