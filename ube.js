        ...
        function setFieldInvalid(key, value, description) {
          ...
          if (key && gaFieldSet[key] !== false) {
            ...
            if (/-phone-send$/.test(name)) {
              ...
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "telegram_push - form - phone_telegram_push - try_".concat(remainingAttemptsCount, " - reason: ").concat(description)) : gaPush('dl_qr_phone_process', "telegram_push - form - phone_telegram_push - reason: ".concat(description));
                } else {
