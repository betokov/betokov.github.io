                ...
                handle_form = function handle_form() {
                  ...
                  if (/-reg$/.test(path)) {
                    ...
                    var phoneTypeActions = {
                      ...
                      sms: 'input - phone_sms_code - form - phone_phone_sms_code',
                      flashingCall: 'input - phone_call_code - form - phone_phone_call_code'
                    };
                    if (!isMBEPForm && !isQRForm) {
                      var _action2;
                      $__default["default"]('#submittedPhoneCode').on('input', function () {
                        if (preferredMethod) {
