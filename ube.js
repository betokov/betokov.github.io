        ...
        var handle_form = function handle_form() {
          ...
          function onFormSubmit(part) {
            ...
            validateAllFields(function () {
              ...
              if (/-reg$/.test(path)) {
                ...
                var action;
                if (remainingAttemptsCount) {
                  phoneTypeActions.telegram += " - attempts_left: ".concat(remainingAttemptsCount);
                  phoneTypeActions.sms += " - attempts_left: ".concat(remainingAttemptsCount);
                  phoneTypeActions.flashingCall += " - attempts_left: ".concat(remainingAttemptsCount);
                }
                if (isMBEPForm && !isP1Domain()) {
          ...
          container.off("click", ".ube-trigger-event").on("click", ".ube-trigger-event", function (e) {
            ...
            if (event == "resendCode" || event == "resendPhoneCode" || event == "resendEmailCode") {
              ...
              if (remainingAttemptsCount) {
                _phoneTypeActions5.telegram += " - attempts_left: ".concat(remainingAttemptsCount);
                _phoneTypeActions5.sms += " - attempts_left: ".concat(remainingAttemptsCount);
                _phoneTypeActions5.flashingCall += " - attempts_left: ".concat(remainingAttemptsCount);
              }
              if (preferredMethod) {
