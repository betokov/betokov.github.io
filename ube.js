    ...
    $__default["default"].fn.ube = function (url, options) {
      ...
      function initializeFormByConfig(json) {
        ...
        var handle_form = function handle_form() {
          ...
          var phoneConfirmationType = json === null || json === void 0 || (_json$properties = json.properties) === null || _json$properties === void 0 ? void 0 : _json$properties.confirmationType;
          ...
          if (/-reg$/.test(path)) {
            ...
            if (!hasPreferredMethodContainer && !$__default["default"]('.method-btn').length) {
            ...
            $__default["default"].ajax({
              ...
              error: function error(xhr, resp, text) {
                ...
                if (/-reg$/.test(path)) {
                  ...
                  var action;
                  if (isP1Domain()) gaPush('dl_auth_phone', 'fail - phone', 'technical');else {
                    if (hasPreferredMethodContainer) {
