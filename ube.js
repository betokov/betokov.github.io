var library = (function (exports, $$1) {
    ...
    */
    ...
    var formKeyToConfigKey = function formKeyToConfigKey(key) {
      var keyVariants = ['optin', 'av', 'face', 'login', 'remind', 'cabinet', 'vk', 'terms', 'phone-send', 'phone-check', 'phone', 'coupon'];
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("http://".concat(UBE_HOST, "/api/config/preload/").concat(key));
            case 3:
      ...
      return _createClass(EmailOptin, [{
        ...
        value: function () {
          var _run = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(key, state, cb) {
            var _state$config;
            var options, target, formKey, emailOptinName, isAllowRegBeforeOptin, MAX_RESEND_COUNT, sessionKey, resendCounter, checkAvStatusAndCallback, _state$user;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  checkAvStatusAndCallback = function checkAvStatusAndCallback(targetBlock, targetState) {
                    getAvStatus(state.sessionKey, formKey).done(function (response) {
                      var av = +response.av;
              ...
              var _loop = function _loop(login) {
                if (logins[login]) {
                  $(".ube-auth-".concat(login)).on('click', function () {
                    ...
                    handleSocialAuth(formKey, login, onSocialAuthSuccess);
                  });
                }
              };
      ...
      return _createClass(Survey, [{
        ...
        value: function () {
          var _run = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(key, state, cb) {
            ...
            var formKey, isValidateMode, isBenefitReceived, _isBenefitReceived;
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  if (!((_state$config2 = state.config) !== null && _state$config2 !== void 0 && (_state$config2 = _state$config2.survey) !== null && _state$config2 !== void 0 && _state$config2.checkBenefitReceived)) {
                    _context3.next = 7;
                    break;
                  }
                  _context3.next = 7;
                      ...
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) switch (_context.prev = _context.next) {
                          ...
                          case 6:
                            ...
                            (result === null || result === void 0 ? void 0 : result.message) && $.ube.showPopup && $.ube.showPopup(result.message);
                            throw result;
                          case 10:
                            window.sessionStorage.removeItem('dteCoupon');
    ...
    (function () {
      $__default["default"].fn.ubeScanpackLogin = function (name, callback, options) {
        ...
        function onSocialAuthSuccess(result, socialName) {
          ...
          var sessionKey = result === null || result === void 0 ? void 0 : result.sessionKey;
          switch (result.event) {
            case "authorization_not_found":
              if (!phone) {
    ...
    (function () {
      $.fn.ubeWidget = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, options) {
          var container, faceContainer, loginContainer, timeoutEntity, showPopup, mandatoryParams, globalCtx, state, storedSafeOptions, response, skipFace, startContent, processDefaultUJ, processCustomUJ, next, startRedirect, startFaceReco, startLogin, startCustomUJ, _runBlockRecursive, getNextBlock, runBlock;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
              ...
              case 33:
                ...
                startCustomUJ = function startCustomUJ() {
                  return _runBlockRecursive(state.customUJ[0].key, state);
                };
                _runBlockRecursive = function runBlockRecursive(key, state) {
                ...
                runBlock = function runBlock(key, state, cb) {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                checkHash = function _checkHash(json, name) {
                  name = name || null;
                ...
                handle_form = function handle_form() {
                  ...
                  container.off("click", ".ube-trigger-event").on("click", ".ube-trigger-event", /*#__PURE__*/function () {
                    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
                      var event, repeat, cabinetUrl, preferredMethod, action, phoneTypeActions, data, formData, _category16, _phoneTypeActions5, _options$data2, key, finalUrl;
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) switch (_context.prev = _context.next) {
                          case 0:
                            e.preventDefault();
                          ...
                          case 3:
                            ...
                            if (event.includes('close') && isQRForm) {
                              ...
                              gaPush("".concat(categoryPrefix, "phone_process"), action);
                            ...
                            _category16 = isQRForm ? 'dl_qr_' : 'dl_auth_';
                            if (/-phone-check$/.test(path)) {
                              ...
                              gaPush("".concat(_category16, "phone_process"), action);
                            }
