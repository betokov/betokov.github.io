          ...
          function sendBlobToServer(blob, callback, type, imageData) {
            ...
            var xhrRequest = $__default["default"].ajax({
              ...
              error: function error(err) {
                ...
                logACSResultToELK(eventType, false, true, 'Network Error', imageData, b64Img, name, token);
              },
              success: function success(data) {
                clearTimeout(timeoutId);
                toggleLoader(false);
                ...
                if (data) {
                  ...
                  if (data.status_code === "SUCCESS" && !window.bad) {
                    ...
                    logACSResultToELK(eventType, false, false, detailMessage, imageData, b64Img, name, token);
                    if (data.errors_detail) {
                      ...
                      logACSResultToELK(eventType, false, false, _errorMessage, imageData, b64Img, name, token);
                    ...
                    logACSResultToELK(eventType, false, false, _detailMessage, imageData, b64Img, name, token);
                    if (data.errors_detail) {
