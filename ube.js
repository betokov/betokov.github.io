var library = (function (exports, $$1) {
    ...
    */
    ...
    function _runWithPriority() {
      _runWithPriority = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(priorityVendor, vendors, mapperFunction) {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              otherFunctions.forEach(function (key) {
                return mapperFunction[key](false);
              });
              _context.next = 6;
              return mapperFunction[priorityFunction](true);
            case 6:
    ...
    function setSessionData(data, token, callback) {
      if (data.sessionKey) {
        var d = new Date();
    ...
    (function () {
      ...
      var mapperFunction = {
        'idx': function idx(priorityFunction) {
          ...
          var xhrRequest = $__default["default"].ajax({
            url: "".concat($__default["default"].ube.host, "/api/faceReco/verifyFace/").concat(configName.replace('-face', '-reg')),
            data: JSON.stringify({
              image: b64Img,
              type: type,
              imageData: imageData
            ...
            error: function error(err) {
              if (priorityFunction) {
                ...
                gaPush("".concat(categoryPrefix, "av_fr_fail"), "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount), " - reason: technical"));
              }
            ...
            success: function success(data) {
              if (priorityFunction) {
                ...
                if (data.isAdult) {
                  ...
                  gaPush("".concat(categoryPrefix, "av_fr_success"), "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount)));
                  data.jwt && ubeCookie$1(cookies.UBE_JWT_FACE_TOKEN, data.jwt);
                  setSessionData(data, data.token, faceState === null || faceState === void 0 || (_faceState$options = faceState.options) === null || _faceState$options === void 0 ? void 0 : _faceState$options.onSubmissionSuccess);
                } else {
                  gaPush("".concat(categoryPrefix, "av_fr_fail"), "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount)));
                  if (tryCount < 2) {
                    tryCount++;
                    fcm.reload();
                    !data.result ? showPopup("Функция недоступна, попробуйте еще раз!") : showPopup(tooYoungMessage);
                  } else {
                    if (type === 'auto') fcm.unmount();
                    onError("limit", data);
                  }
                }
              } else if (data.isAdult) {
                isFaceAgeVerified = true;
              }
            }
          });
          if (priorityFunction) {
            timeoutId = setTimer(xhrRequest, tenSeconds);
          }
        },
        'yoti': function yoti(priorityFunction) {
              ...
              if (data) {
                ...
                if (status_code === "SUCCESS" && !window.bad) {
                  ...
                  if (priorityFunction) {
                    if (type === 'auto') fcm.unmount();
                    onError("limit", data);
                    gaPush("".concat(categoryPrefix, "av_fr_fail"), "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount, error_message), " - reason: ").concat(error_message));
                  }
                  ...
                  if (priorityFunction) {
                    ...
                    if (errors_detail) {
                      ...
                      gaPush("".concat(categoryPrefix, "av_fr_fail"), "form - fr_".concat(type, " - ").concat(getAttemptLabel(tryCount, _error_message), " - reason: ").concat(_error_message));
                    }
                    if (tryCount < 2) {
                      ...
                      if (options !== null && options !== void 0 && (_options$acsOptions = options.acsOptions) !== null && _options$acsOptions !== void 0 && _options$acsOptions.debugMode && errors_detail) {
                        ...
                        $__default["default"]('.server-error-message').html(JSON.stringify(errors_detail));
                      }
                      showPopup(errorText);
                    } else {
                      if (type === 'auto') fcm.unmount();
      ...
      function onError(event, data) {
        ...
        (faceState === null || faceState === void 0 || (_faceState$options2 = faceState.options) === null || _faceState$options2 === void 0 ? void 0 : _faceState$options2.onSubmissionError) && faceState.options.onSubmissionError(event, data);
      ...
      function onSuccess(token, captureType) {
        validateToken(token, captureType, function (result) {
          ...
          (result === null || result === void 0 ? void 0 : result.data) && setSessionData(result.data, token, faceState === null || faceState === void 0 || (_faceState$options3 = faceState.options) === null || _faceState$options3 === void 0 ? void 0 : _faceState$options3.onSubmissionSuccess);
        }, null);
      }
      function setTimer(xhrRequest, time) {
      ...
      $__default["default"].fn.ubeFace = function (name, options) {
        ...
        function initializeFaceCapture(_token, _tokenUrl) {
          ...
          function sendBlobToServer() {
            var label = tryCount === 1 ? 'first' : 'second';
            var vendors = isFaceAgeVerified ? [] : vendorsList;
            toggleLoader(true);
            ...
            runWithPriority(primaryFaceVendor, vendors, mapperFunction);
          }
          function renderCameraCapture() {
            if (isNoCameraStream) {
    ...
    (function () {
      $.fn.ubeWidget = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, options) {
          var container, faceContainer, loginContainer, timeoutEntity, showPopup, mandatoryParams, globalCtx, state, response, skipFace, startContent, processDefaultUJ, processCustomUJ, next, startRedirect, startFaceReco, startLogin, startCustomUJ, _runBlockRecursive, getNextBlock, runBlock;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
    ...
    $__default["default"].fn.ube = function (url, options) {
      ...
      Impression.runImpression(getKeyFromUrl(((_url = url) === null || _url === void 0 || (_url = _url.data) === null || _url === void 0 ? void 0 : _url.template) || url));
                ...
                success: function success(data) {
                  ...
                  if (data) {
                    ...
                    if (data.status_code === "SUCCESS" && !window.bad) {
                      ...
                      logACSResultToELK(eventType, false, false, _detailMessage, imageData, b64Img, name, true);
                      if (tryCount < 2) {
                        tryCount++;
                        fcm.reload();
