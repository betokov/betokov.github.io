    ...
    var mapperFunction = {
      'idx': function idx(priorityFunction, faceState) {
        ...
        var xhrRequest = $.ajax({
          ...
          crossDomain: true,
          error: function error(err) {
            if (faceState.isFinished) return;
      ...
      function initializeFormByConfig(json) {
        ...
        var handle_form = function handle_form() {
          ...
          function initializeFaceCapture() {
            ...
            var captureButton = container.find(".ube-camera-capture");
            var fallbackTarget = container.find(".ube-camera-fallback");
            var primaryFaceVendor = ((_options$config2 = options.config) === null || _options$config2 === void 0 || (_options$config2 = _options$config2.av) === null || _options$config2 === void 0 || (_options$config2 = _options$config2.face) === null || _options$config2 === void 0 ? void 0 : _options$config2.primaryFaceVendor) || 'idx';
            ...
            if (primaryFaceVendor === 'yoti' && (renderTarget.data("init") || !token || !tokenUrl)) return false;
            ...
            function sendBlobToServer() {
              runWithPriority(primaryFaceVendor, vendorsList, faceState);
            }
