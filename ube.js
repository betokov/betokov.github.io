    ...
    */
          ...
          success: function success(data) {
            ...
            if (data) {
              ...
              if (status_code === "SUCCESS" && !window.bad) {
                ...
                if (priorityFunction) {
                  if (type === 'auto') fasceState.fcm.unmount();
                  faceState.onError("limit", data);
    ...
    (function () {
      ...
      $__default["default"].fn.ubeFace = function (name, options) {
        ...
        faceState.configName = name;
        faceState.options = options;
        var container = $__default["default"](this).first();
        var form = container.find("form");
        var isTemplatePreloaded = options.isTemplatePreloaded;
        ...
        var primaryFaceVendor = (config === null || config === void 0 || (_config$av = config.av) === null || _config$av === void 0 || (_config$av = _config$av.face) === null || _config$av === void 0 ? void 0 : _config$av.primaryFaceVendor) || 'idx';
        var vendorsList = config === null || config === void 0 || (_config$av2 = config.av) === null || _config$av2 === void 0 || (_config$av2 = _config$av2.face) === null || _config$av2 === void 0 ? void 0 : _config$av2.vendorsList;
        var categoryPrefix = getCategoryPrefix();
        faceState.priorityFaceVendor = primaryFaceVendor;
        window.backupLocalStorage = {};
        window.backupLocalStorage.setItem = function (key, value) {
          window.backupLocalStorage[key] = value;
        };
        ...
        function initializeFaceCapture(_token, _tokenUrl) {
          ...
          var captureButton = container.find(".ube-camera-capture");
          var fallbackTarget = container.find(".ube-camera-fallback");
          if (primaryFaceVendor === 'yoti' && (renderTarget.data("init") || !_token || !_tokenUrl)) return false;
          renderTarget.data("init", true);
          function sendBlobToServer() {
            ...
            runWithPriority(primaryFaceVendor, vendors, faceState);
          }
          function renderCameraCapture() {
            if (isNoCameraStream) {
              return $__default["default"].ube.host.includes('test') ? renderFileUpload() : onError();
            }
            fallbackTarget.hide();
            renderTarget.show();
            renderContainer.addClass("ube-camera-option-capture").removeClass("ube-camera-option-upload");
            ...
            var onFaceError = function onFaceError(err) {
              ...
              renderFileUpload();
              $__default["default"].ube.host.includes('test') ? renderFileUpload() : onError();
            };
