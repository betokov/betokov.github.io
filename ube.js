            ...
            onFormLoad: function onFormLoad() {
              if ($('.ube-phone-send-preferredMethod').length) {
                ...
                $('.method-btn').on('click', function (e) {
                  ...
                  $('.ube-phone-send-preferredMethod').data('method', method).hide();
        ...
        function setFieldInvalid(key, value, description) {
          ...
          if (key && gaFieldSet[key] !== false) {
            ...
            if (/-phone-send$/.test(name)) {
              ...
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - form - phone_telegram_push - try_".concat(remainingAttemptsCount, " - reason: ").concat(description)) : gaPush('dl_qr_phone_process', "sms_code - form - phone_telegram_push - reason: ".concat(description));
                } else {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - form - phone_sms_code - try_".concat(remainingAttemptsCount, " - reason: ").concat(description)) : gaPush('dl_qr_phone_process', "sms_code - form - phone_sms_code - reason: ".concat(description));
                }
              } else {
        ...
        var handle_form = function handle_form() {
            ...
            $__default["default"].ajax({
              ...
              error: function error(xhr, resp, text) {
                ...
                if (/-reg$/.test(path)) {
                  ...
                  if (preferredMethod) {
                    if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                      remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - form - phone_telegram_push - try_".concat(remainingAttemptsCount, " - reason: technical")) : gaPush('dl_qr_phone_process', "sms_code - form - phone_telegram_push - reason: ".concat(description));
                    } else {
          ...
          container.off("click", ".ube-trigger-event").on("click", ".ube-trigger-event", function (e) {
            ...
            if (event == "resendCode" || event == "resendPhoneCode" || event == "resendEmailCode") {
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - send_again - form - phone_telegram_push - try_".concat(remainingAttemptsCount)) : gaPush('dl_qr_phone_process', "sms_code - send_again - form - phone_telegram_push");
                } else {
          ...
          if (options.onFormLoad) options.onFormLoad();
