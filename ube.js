    ...
    */
    ...
    var mapperFunction = {
      'idx': function idx(priorityFunction, faceState) {
        ...
        if (priorityFunction) {
          timeoutId = setTimer(xhrRequest, faceState);
        }
      },
    ...
    function setTimer(xhrRequest, faceState) {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(configFromSession && !isSafeOptionsLoaded)) {
                  _context.next = 38;
                  break;
                }
                options.config = configFromSession;
                isSafeOptionsLoaded = true;
                _context.next = 45;
                break;
              case 38:
                if (isSafeOptionsLoaded) {
                  _context.next = 45;
                  break;
                }
                _context.next = 41;
              ...
              case 41:
                ...
                isSafeOptionsLoaded = true;
                ubeSession("".concat(configKey, "_config"), JSON.stringify(res === null || res === void 0 ? void 0 : res.config));
              case 45:
