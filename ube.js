var library = (function (exports, $$1) {
    ...
    */
    ...
    function handleSocialAuth$1(formKey, socialName, cb) {
      authBySocial({
        formKey: formKey,
        ...
        errorCB: function errorCB(error) {
          gaPush('dl_qr_auth_social_fail', "view - pop_up_fail_social - ".concat(socialNamesMapping$1[socialName]));
      ...
      $__default["default"].fn.ubeScanpackLogin = function (name, callback, options) {
        ...
        var handleTextVisibility = function handleTextVisibility() {
          ...
          $__default["default"]('.ube-auth-social').on('click', function (e) {
            ...
            handleSocialAuth$1(name, socialName, onSocialAuthSuccess);
          });
        };
        function onSocialAuthSuccess(result, socialName) {
          var _result$user2;
          ...
          gaPush('dl_qr_auth_social_success', "form - social - ".concat(socialNamesMapping$1[socialName]));
        }
