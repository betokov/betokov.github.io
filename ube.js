        ...
        value: function run(key, state, cb) {
          ...
          target.show().ube(phoneSendName, {
            ...
            onFormLoad: function onFormLoad(_ref) {
              ...
              if (hasPreferredMethodContainer || methodBtn.length) gaPush("".concat(categoryPrefix, "phone_process"), 'view - screen_fork');
              methodBtn.on('click', function (e) {
                ...
                if (method === 'telegram' && alternativeCaptchaEnabled && alternativeGrecaptcha) {
                  ...
                  gaPush("".concat(categoryPrefix, "phone_process"), "click - phone_".concat(method, "_push - screen_fork"));
                  if (hasPreferredMethodContainer) gaPush("".concat(categoryPrefix, "phone_start"), "form - phone_telegram_push");
                } else {
                  gaPush("".concat(categoryPrefix, "phone_process"), "click - phone_".concat(method, "_code - screen_fork"));
                  if (hasPreferredMethodContainer) gaPush("".concat(categoryPrefix, "phone_start"), "form - phone_sms_code");
                }
