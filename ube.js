var library = (function (exports, $$1) {
    ...
    */
    ...
    function faceAgeTimer() {
      ...
      faceTimerInterval = setInterval(function () {
        timeLeft--;
        if (timeLeft < 0) {
          clearInterval(faceTimerInterval);
          faceTimerInterval = null;
          $timer.remove();
          return;
        }
        $seconds.text(timeLeft);
    ...
    function stopFaceAgeTimer() {
      console.log(111, faceTimerInterval);
      if (faceTimerInterval) {
        clearInterval(faceTimerInterval);
        faceTimerInterval = null;
      }
      $('.ube-face-timer').remove();
      console.log(222, faceTimerInterval);
    }
