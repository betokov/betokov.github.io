                  ...
                  function onFormSubmit(part) {
                    ...
                    validateAllFields(function () {
                      ...
                      if (/-reg$/.test(path)) {
                        ...
                        gaPush(_category11, 'send - form - registration');
                      } else if (/optin$/.test(path)) {
                        actionPathOptin({
                          path: path,
                          configKey: configKey,
                        ...
                        if (isMBEPForm && !isP1Domain()) {
                          ...
                          if (phoneConfirmationType === 'telegram') {
                            gaPush("".concat(_category15, "phone_start"), "form - phone_telegram_push");
                          } else if (phoneConfirmationType === 'sms') {
                            gaPush("".concat(_category15, "phone_start"), "form - phone_sms_code");
                          } else if (phoneConfirmationType === 'flashingCall') {
                            gaPush("".concat(_category15, "phone_start"), "form - phone_call_code");
                          }
                        }
                        gaPush(_category14, _action12);
                      } else if (/-idx$/.test(path)) {
                        action_path = "/esb/" + path + "/submission";
