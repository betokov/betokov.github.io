    ...
    */
      ...
      return _createClass(PhoneSend, [{
        ...
        value: function run(key, state, cb) {
          ...
          function handleSocialAuth(formKey, socialName) {
            authBySocial({
              ...
              errorCB: function errorCB(error) {
                gaPush('dl_auth_social_fail', "view - pop_up_fail_social - ".concat(socialNamesMapping[socialName]));
          ...
          function onSocialAuthSuccess(result, socialName) {
            ...
            gaPush('dl_auth_social_success', "form - social - ".concat(socialNamesMapping[socialName]));
          }
            ...
            onFormLoad: function onFormLoad(_ref) {
              ...
              if ($('.ube-phone-send-preferredMethod').length) {
                $('.method-btn').on('click', function (e) {
                  ...
                  sessionStorage.setItem('phoneSendMethod', method);
                });
              }
              var _loop = function _loop(login) {
                if (logins[login]) {
                  $(".ube-auth-".concat(login)).on('click', function () {
                    gaPush('dl_auth_social_start', "click - icon: ".concat(socialNamesMapping[login]));
                    ...
                    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
                      ...
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return fetch("".concat($.ube.host, "/api/session/").concat(_this.name, "/survey"), {
                              method: 'POST',
                              headers: {
                                "Content-Type": "application/json",
    ...
    $__default["default"].fn.ube = function (url, options) {
      ...
      function initializeFormByConfig(json) {
        ...
        var categoryPrefix = isQRForm ? 'dl_qr_' : 'dl_';
        var remainingAttemptsCount, preferredMethod;
        ...
        function setFieldInvalid(key, value, description) {
          ...
          if (key && gaFieldSet[key] !== false) {
            ...
            if (/-phone-send$/.test(name)) {
              ...
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  gaPush(category, "number - form - phone_telegram_push - reason: ".concat(description));
                } else {
                  gaPush(category, "number - form - phone_sms_code - reason: ".concat(description));
                }
              } else {
                gaPush(category, "form - phone_number - reason: ".concat(description));
              }
            } else if (/-phone-check$/.test(name)) {
              var _category = isQRForm ? 'dl_qr_phone_fail' : 'dl_auth_phone_fail';
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  remainingAttemptsCount ? gaPush(_category, "telegram_push - form - phone_telegram_push - try_".concat(remainingAttemptsCount, " - reason: ").concat(description)) : gaPush(_category, "telegram_push - form - phone_telegram_push - reason: ".concat(description));
                } else {
                  remainingAttemptsCount ? gaPush(_category, "sms_code - form - phone_sms_code - try_".concat(remainingAttemptsCount, " - reason: ").concat(description)) : gaPush(_category, "sms_code - form - phone_sms_code - reason: ".concat(description));
                }
              } else {
                gaPush(_category, "form - phone_code - reason: ".concat(description));
              }
        ...
        var handle_form = function handle_form() {
          ...
          var action_path;
          var ga_name;
          preferredMethod = $__default["default"]('.ube-phone-send-preferredMethod').length;
            ...
            $__default["default"].ajax({
              ...
              error: function error(xhr, resp, text) {
                ...
                if (/-reg$/.test(path)) {
                  ...
                  if (isP1Form) gaPush('dl_auth_phone', 'fail - phone', 'technical');else {
                    if (preferredMethod) {
                      if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                        gaPush(_category5, "number - form - phone_telegram_push - reason: technical");
                      } else {
                        gaPush(_category5, "number - form - phone_sms_code - reason: technical");
                      }
                    } else {
                      gaPush(_category5, "form - phone_number - reason: technical");
                    }
                  }
                } else if (/-phone-send$/.test(path)) {
                  action_path = "/esb/" + path + "/submission";
                  ...
                  if (preferredMethod) {
                    if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                      remainingAttemptsCount ? gaPush('dl_qr_phone_process', "telegram_push - form - phone_telegram_push - try_".concat(remainingAttemptsCount, " - reason: technical")) : gaPush('dl_qr_phone_process', "telegram_push - form - phone_telegram_push - reason: ".concat(description));
                    } else {
                      remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - form - phone_sms_code - try_".concat(remainingAttemptsCount, " - reason: technical")) : gaPush('dl_qr_phone_process', "sms_code - form - phone_sms_code - reason: technical");
                    }
                  } else {
                    gaPush(_category6, "form - phone_code - reason: technical");
                  }
                } else if (/-idx$/.test(path)) {
                  action_path = "/esb/" + path + "/submission";
                  ga_name = "IDXVerification";
              ...
              function submissionSuccess(result) {
                ...
                if (name.includes('phone-send')) {
                  ...
                  if (preferredMethod) {
                    if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                      gaPush(_category7, "send - telegram_push_to_las - form - phone_telegram_push");
                    } else {
                      gaPush(_category7, "send - sms_code_to_las - form - phone_sms_code");
                    }
                  } else {
                    gaPush(_category7, 'send - code');
                  }
                  ...
                  if (preferredMethod) {
                    if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                      action = "form - phone_telegram_push - (".concat(result.event === 'loginSuccess' ? 'in_base' : 'not_in_base', ")");
                    } else {
                      action = "form - phone - (".concat(result.event === 'loginSuccess' ? 'in_base' : 'not_in_base', ")");
                    }
                  } else {
                    action = "form - phone - (".concat(result.event === 'loginSuccess' ? 'in_base' : 'not_in_base', ")");
                  }
                  if (remainingAttemptsCount) {
                    gaPush(_category8, action + ' - try_' + remainingAttemptsCount);
                  } else {
                    gaPush(_category8, action);
                  }
                ...
                if (ga_name === 'LoginRemind') gaPush(categoryPrefix + 'auth_resetPassword_success', 'form - resetPassword');else if (ga_name === 'Login') {
                  ...
                  gaPush(categoryPrefix + 'auth_password_success', "form - password - ".concat(_action));
                }
          ...
          function onFormSubmit(part) {
            ...
            validateAllFields(function () {
              ...
              if (/-reg$/.test(path)) {
                ...
                if (preferredMethod) {
                  if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                    remainingAttemptsCount ? gaPush(_category11, "send - telegram_push - form - phone_telegram_push - try_".concat(remainingAttemptsCount)) : gaPush(_category11, "send - telegram_push - form - phone_telegram_push");
                  } else {
                    remainingAttemptsCount ? gaPush(_category11, "send - sms_code - form - phone_sms_code - try_".concat(remainingAttemptsCount)) : gaPush(_category11, "send - sms_code - form - phone_sms_code");
                  }
                } else {
                  gaPush(_category11, 'send - form - phone_code');
                }
              } else if (/-phone-send$/.test(path)) {
                var _category12 = isQRForm ? 'dl_qr_phone_process' : 'dl_auth_phone_process';
                if (preferredMethod) {
                  if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                    gaPush(_category12, "send - number - form - phone_telegram_push");
                  } else {
                    gaPush(_category12, "send - number - form - phone_sms_code");
                  }
                } else {
                  gaPush(_category12, 'send - form - phone_number');
                }
              } else if (/-idx$/.test(path)) {
                action_path = "/esb/" + path + "/submission";
          ...
          container.find(".ube-trigger-event").off("click").on("click", function (e) {
            e.preventDefault();
            ...
            if (name.includes('phone-check')) {
              gaPush(categoryPrefix + "auth_phone_process", "click - button - back");
            } else if (name.includes('optin')) {
              gaPush(categoryPrefix + "2optin_process", "click - button - back");
            } else if (event.includes('close') && isQRForm) {
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  gaPush('dl_qr_phone_process', 'click - button - change_phone - form - phone_telegram_push');
                } else {
                  gaPush('dl_qr_phone_process', 'click - button - change_phone - form - phone_sms_code');
                }
              } else {
                gaPush('dl_qr_phone_process', 'click - button - change_phone');
              }
            } else if (name.includes('cabinet')) {
              gaPush('dl_lk_profile', 'confirm - ' + event.split('-').slice(-1).join());
            } else if (!event.includes('social-login')) {
              gaPush("UBE", event, name);
            }
            click - button - change_phone - form - phone_telegram_push;
            ...
            if (event == "resendCode" || event == "resendPhoneCode" || event == "resendEmailCode") {
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "telegram_push - send_again - form - phone_telegram_push - try_".concat(remainingAttemptsCount)) : gaPush('dl_qr_phone_process', "telegram_push - send_again - form - phone_telegram_push");
                } else {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - send_again - form - phone_sms_code - try_".concat(remainingAttemptsCount)) : gaPush('dl_qr_phone_process', "sms_code - send_again - form - phone_sms_code");
                }
              }
              $__default["default"].ajax({
