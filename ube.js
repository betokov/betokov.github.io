          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                configFromSession = JSON.parse(sessionStorage.getItem("".concat(configKey, "_config")));
              ...
              case 39:
                ...
                sessionStorage.setItem("".concat(configKey, "_config"), JSON.stringify(res === null || res === void 0 ? void 0 : res.config));
              case 42:
