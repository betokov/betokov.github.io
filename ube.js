var library = (function (exports, $$1) {
    ...
    */
    ...
    var UBE_HOST = new URL(document.currentScript.src).host;
    ...
    function send(data) {
      ...
      return fetch("https://".concat(UBE_HOST, "/api/impression/token"), options).then(function (response) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("https://".concat(UBE_HOST, "/api/config/preload/").concat(key));
            case 3:
