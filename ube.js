      ...
      function initializeFormByConfig(json) {
        ...
        function setFieldInvalid(key, value, description) {
          ...
          if (key && gaFieldSet[key] !== false) {
            getField(key);
            var _preferredMethod = ubeSession('preferredMethod');
            if (/-phone-send$/.test(name)) {
              ...
              } else if (_preferredMethod) {
                action = phoneTypeActions[_preferredMethod];
              ...
              if (isMBEPForm) {
                ...
                _action = _phoneTypeActions[_preferredMethod];
              } else if (phoneConfirmationType) {
