    ...
    */
    ...
    var savePESessionData = function savePESessionData(data) {
      ...
      keys.forEach(function (key) {
        if (data[key]) ubeSession(key, data[key]);
      });
    };
    ...
    var EmailOptin = /*#__PURE__*/function (_Block) {
      ...
      return _createClass(EmailOptin, [{
        key: "run",
        value: function () {
          var _run = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(key, state, cb) {
            var _state$config;
            ...
            onSubmissionSuccess: function onSubmissionSuccess(submissionId, userId, result) {
              ...
              switch (result.event) {
                ...
                case "2optin":
                  ...
                  var email = result === null || result === void 0 || (_result$data = result.data) === null || _result$data === void 0 || (_result$data = _result$data.data) === null || _result$data === void 0 || (_result$data = _result$data.person) === null || _result$data === void 0 ? void 0 : _result$data.email;
                  if (email) {
      ...
      return _createClass(Survey, [{
        ...
        value: function () {
          var _run = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(key, state, cb) {
            var _state$config;
            var formKey, isValidateMode, response, _state$config2, _response$data, hasBenefit, restrictSamePromo;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  formKey = this.name;
                  ...
                  toggleLoader(true);
                  _context2.next = 5;
                  return checkRestriction(formKey, state.sessionKey);
                case 5:
                  response = _context2.sent;
                  if (response !== null && response !== void 0 && response.data) {
                    ...
                    if ((_state$config2 = state.config) !== null && _state$config2 !== void 0 && (_state$config2 = _state$config2.survey) !== null && _state$config2 !== void 0 && _state$config2.checkBenefitReceived && hasBenefit) {
      ...
      $__default["default"].fn.ubeScanpackLogin = function (name, callback, options) {
        ...
        function loadEmailSend() {
          emailSendContainer.show().ube(emailSendName, {
            ...
            onSubmissionSuccess: function onSubmissionSuccess(submissionId, userId, result) {
              if (result.event === 'success') {
                loadEmailCheck(result.data.sessionKey);
              }
            }
          });
        }
        function loadEmailCheck(sessionKey) {
        ...
        function loadPhoneSend() {
          ...
          phoneSendContainer.show().ube(phoneSendName, {
            ...
            onFormLoad: function onFormLoad() {
              ...
              initSocialAuth();
              $__default["default"]('.ube-select-preferredMethod').click(function () {
                $__default["default"]('.ube-preferredMethod, .ube-preferredMethod-shadow').addClass('ube-preferredMethod_show');
              });
              $__default["default"]('.ube-preferredMethod-btn').click(function () {
                var method = $__default["default"](this).data("method");
                formData.preferredMethod = method;
                preferredMethod = method;
                incrementSentCounter();
              });
              $__default["default"]('.ube-preferredMethod-shadow, .ube-preferredMethod--close, .ube-preferredMethod-btn').click(function () {
                $__default["default"]('.ube-preferredMethod-shadow, .ube-preferredMethod').removeClass('ube-preferredMethod_show');
              });
            },
                ...
                handle_form = function handle_form() {
                  ...
                  container.off("click", ".ube-trigger-event").on("click", ".ube-trigger-event", /*#__PURE__*/function () {
                    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
                      var event, repeat, cabinetUrl, preferredMethod, category, action, phoneTypeActions, data, formData, _phoneTypeActions5, _options$data2, key, finalUrl;
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) switch (_context.prev = _context.next) {
                          case 0:
                            e.preventDefault();
                          ...
                          case 3:
                            ...
                            if (!(isAllowRegBeforeOptin && action_path.includes('/changeEmail'))) {
                              _context.next = 29;
                              break;
                            }
                            _context.prev = 15;
                          ...
                          case 18:
                            _context.next = 20;
                            return changeEmail(configKey, (_options$data2 = options.data) === null || _options$data2 === void 0 || (_options$data2 = _options$data2.person) === null || _options$data2 === void 0 ? void 0 : _options$data2.email, options.sessionKey);
                          case 20:
