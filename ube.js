      ...
      function initializeFormByConfig(json) {
        ...
        var handle_form = function handle_form() {
          ...
          if (/-reg$/.test(path)) {
            ...
            if (ubeSession('shouldSkipEmail') === 'true') {
              gaPush(_category3, 'form - 2optin - with_email');
            } else if (ubeSession('shouldSkipEmail') === 'false') {
              if (ubeSession('skipedEmailOptin') === 'false') {
                gaPush(_category3, 'form - 2optin - wo_email');
              } else {
                gaPush(_category3, 'form - 2optin - wo_email_leave_email');
              }
            }
            gaPush(_category3, 'form - 2optin');
            ga_name = "2OPTIN";
            ...
            $__default["default"].ajax({
              ...
              function submissionSuccess(result) {
                ...
                if (name.includes('phone-send')) {
                  ...
                  if (ubeSession('shouldSkipEmail') === 'true') {
                    gaPush(_category9, 'form - registration - with_email');
                  } else if (ubeSession('shouldSkipEmail') === 'false') {
                    if (ubeSession('skipedEmailOptin') === 'false') {
                      gaPush(_category9, 'form - registration - wo_email');
                    } else {
                      gaPush(_category9, 'form - registration - wo_email_leave_email');
                    }
                  }
                  ...
                  if (ubeSession('shouldSkipEmail') === 'true') {
                    gaPush(_category10, 'form - 2optin - with_email');
                  } else if (ubeSession('shouldSkipEmail') === 'false') {
                    if (ubeSession('skipedEmailOptin') === 'false') {
                      gaPush(_category10, 'form - 2optin - wo_email');
                    } else {
                      gaPush(_category10, 'form - 2optin - wo_email_leave_email');
                    }
                  }
                  gaPush(_category10, 'form - 2optin');
          ...
          function onFormSubmit(part) {
            ...
            validateAllFields(function () {
              ...
              if (/-reg$/.test(path)) {
                ...
                if (ubeSession('shouldSkipEmail') === 'true') {
                  gaPush(_category12, 'send - form - 2optin - with_email');
                } else if (ubeSession('shouldSkipEmail') === 'false') {
                  if (ubeSession('skipedEmailOptin') === 'false') {
                    gaPush(_category12, 'send - form - 2optin - wo_email');
                  } else {
                    gaPush(_category12, 'send - form - 2optin - wo_email_leave_email');
                  }
                }
                gaPush(_category12, 'send - form - 2optin');
                ga_name = "2OPTIN";
              } else if (/av$/.test(path)) {
                action_path = "/esb/" + path + "/submission";
                ga_name = "AV";
