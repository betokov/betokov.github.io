    ...
    */
        ...
        value: function run(key, state, cb) {
          ...
          target.show().ube(phoneSendName, {
            ...
            onFormLoad: function onFormLoad(_ref) {
              ...
              if (hasPreferredMethodContainer || methodBtn.length) gaPush('dl_qr_phone_process', 'view - screen_fork');
              methodBtn.on('click', function (e) {
                ...
                if (method === 'telegram' && alternativeCaptchaEnabled && alternativeGrecaptcha) {
                  ...
                  if (hasPreferredMethodContainer) gaPush('dl_qr_phone_start', "form - phone_telegram_push");
                } else {
                  gaPush('dl_qr_phone_process', "click - phone_".concat(method, "_code - screen_fork"));
                  if (hasPreferredMethodContainer) gaPush('dl_qr_phone_start', "form - phone_sms_code");
                }
    ...
    function validateYandexCaptcha(container, callback) {
      ...
      if (captchaId) {
        ...
        } else if (preferredMethod === 'telegram' || phoneConfirmationType === 'telegram') {
