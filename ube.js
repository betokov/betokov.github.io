            ...
            onFormLoad: function onFormLoad() {
              ...
              if (ubeSession('shouldSkipEmail') === 'false') {
                ...
                $('.skipEmailOptin').on('click', function () {
                  if ($(this).data('event')) {
                    $('input[name="skipEmailOptin"]').val(true);
      ...
      function initializeFormByConfig(json) {
        ...
        var handle_form = function handle_form() {
          ...
          if (/-reg$/.test(path)) {
            ...
            var action = "form - registration";
            if (!isMBEPForm) {
              if (ubeSession('shouldSkipEmail') === 'true') {
                action = 'form - registration - with_email';
              } else if (ubeSession('shouldSkipEmail') === 'false') {
                if (ubeSession('skipedEmailOptin') === 'false') {
                  action = 'form - registration - wo_email';
                } else {
                  action = 'form - registration - wo_email_leave_email';
                }
              }
              gaPush(category, action);
            }
            ...
            var _action2 = 'form - 2optin';
            if (ubeSession('shouldSkipEmail') === 'true') {
              _action2 = 'form - 2optin - with_email';
            } else if (ubeSession('shouldSkipEmail') === 'false') {
              if (ubeSession('skipedEmailOptin') === 'false') {
                _action2 = 'form - 2optin - wo_email';
              } else {
                _action2 = 'form - 2optin - wo_email_leave_email';
              }
            }
            gaPush(categoryPrefix + "2optin_start", _action2);
            ga_name = "2OPTIN";
            ...
            $__default["default"].ajax({
              ...
              error: function error(xhr, resp, text) {
                ...
                if (/-reg$/.test(path)) {
                  ...
                  gaPush(_category3, "form - registration - reason: technical");
                  if (isMBEPForm) {
                  ...
                  var _category4 = isQRForm ? 'dl_qr_phone_fail' : 'dl_auth_phone_fail';
                  var phoneTypeActions = {
                  ...
                  if (isMBEPForm && !isP1Domain()) {
                    ...
                    _action3 = phoneTypeActions[preferredMethod];
                  } else if (phoneConfirmationType) {
                    _action3 = phoneTypeActions[phoneConfirmationType];
                  }
                  gaPush(_category4, _action3);
                } else if (/-phone-send$/.test(path)) {
                  action_path = "/esb/" + path + "/submission";
                  ...
                  if (isMBEPForm && !isP1Domain()) {
                    ...
                    _action4 = _phoneTypeActions2[preferredMethod];
                  } else if (phoneConfirmationType) {
                    _action4 = _phoneTypeActions2[phoneConfirmationType];
                  }
                  gaPush(_category5, _action4);
                } else if (/-idx$/.test(path)) {
                  action_path = "/esb/" + path + "/submission";
                  ga_name = "IDXVerification";
              ...
              function submissionSuccess(result) {
                ...
                if (name.includes('phone-send')) {
                  var _category6 = isQRForm ? 'dl_qr_phone_process' : 'dl_auth_phone_process';
                  var phoneTypeActions = {
                  ...
                  if (isMBEPForm && !isP1Domain()) {
                    ...
                    _action5 = phoneTypeActions[preferredMethod];
                  } else if (phoneConfirmationType) {
                    _action5 = phoneTypeActions[phoneConfirmationType];
                  }
                  gaPush(_category6, _action5);
                  ...
                  var _category7 = isQRForm ? 'dl_qr_phone_success' : 'dl_auth_phone_success';
                  ...
                  if (isMBEPForm && !isP1Domain()) {
                    ...
                    _action6 = _phoneTypeActions3[preferredMethod];
                  } else if (phoneConfirmationType) {
                    _action6 = _phoneTypeActions3[phoneConfirmationType];
                  }
                  gaPush(_category7, _action6);
                  ...
                  var _category8 = isQRForm ? 'dl_qr_registration_success' : 'dl_auth_registration_success';
                  var _action7;
                  if (ubeSession('shouldSkipEmail') === 'true') {
                    _action7 = 'form - registration - with_email';
                  } else if (ubeSession('shouldSkipEmail') === 'false') {
                    if (ubeSession('skipedEmailOptin') === 'false') {
                      _action7 = 'form - registration - wo_email';
                    } else {
                      _action7 = 'form - registration - wo_email_leave_email';
                    }
                  } else {
                    _action7 = 'form - registration';
                  }
                  gaPush(_category8, _action7);
                  ...
                  if (ubeSession('shouldSkipEmail') === 'true') {
                    _action8 = 'form - 2optin - with_email';
                  } else if (ubeSession('shouldSkipEmail') === 'false') {
                    if (ubeSession('skipedEmailOptin') === 'false') {
                      _action8 = 'form - 2optin - wo_email';
                    } else {
                      _action8 = 'form - 2optin - wo_email_leave_email';
                    }
                  }
                  gaPush(categoryPrefix + '2optin_success', _action8);
          ...
          function onFormSubmit(part) {
            ...
            validateAllFields(function () {
              ...
              validationState = {};
              if (/-reg$/.test(path)) {
                var _category9 = isQRForm ? 'dl_qr_registration_process' : 'dl_auth_registration_process';
                gaPush(_category9, 'send - form - registration');
              } else if (/optin$/.test(path)) {
                action_path = "/esb/" + path + "/submitCodes";
                var _action10 = 'send - form - 2optin';
                if (ubeSession('shouldSkipEmail') === 'true') {
                  _action10 = 'send - form - 2optin - with_email';
                } else if (ubeSession('shouldSkipEmail') === 'false') {
                  if (ubeSession('skipedEmailOptin') === 'false') {
                    _action10 = 'send - form - 2optin - wo_email';
                  } else {
                    _action10 = 'send - form - 2optin - wo_email_leave_email';
                  }
                }
                gaPush(categoryPrefix + '2optin_process', _action10);
                ga_name = "2OPTIN";
              } else if (/av$/.test(path)) {
                action_path = "/esb/" + path + "/submission";
                ga_name = "AV";
                ...
                var _category10 = isQRForm ? 'dl_qr_phone_process' : 'dl_auth_phone_process';
                var phoneTypeActions = {
                ...
                if (isMBEPForm && !isP1Domain()) {
                  ...
                  _action11 = phoneTypeActions[preferredMethod];
                } else if (phoneConfirmationType) {
                  _action11 = phoneTypeActions[phoneConfirmationType];
                }
                gaPush(_category10, _action11);
              } else if (/-phone-send$/.test(path)) {
                ...
                if (isMBEPForm && !isP1Domain()) {
                  ...
                  _action12 = _phoneTypeActions4[preferredMethod];
                } else if (phoneConfirmationType) {
                  var _category12 = isQRDomain() ? 'dl_qr_' : 'dl_auth_';
                  _action12 = _phoneTypeActions4[phoneConfirmationType];
                  if (phoneConfirmationType === 'telegram') {
                    gaPush("".concat(_category12, "phone_start"), "form - phone_telegram_push");
                  } else if (phoneConfirmationType === 'sms') {
                    gaPush("".concat(_category12, "phone_start"), "form - phone_sms_code");
                  } else if (phoneConfirmationType === 'flashingCall') {
                    gaPush("".concat(_category12, "phone_start"), "form - phone_call_code");
                  }
                }
                gaPush(_category11, _action12);
              } else if (/-idx$/.test(path)) {
                action_path = "/esb/" + path + "/submission";
          ...
          container.off("click", ".ube-trigger-event").on("click", ".ube-trigger-event", function (e) {
            ...
            if (event == "resendCode" || event == "resendPhoneCode" || event == "resendEmailCode") {
              var _category13 = isQRForm ? 'dl_qr_' : 'dl_auth_';
              ...
              gaPush("".concat(_category13, "phone_process"), action);
              $__default["default"].ajax({
