        ...
        function setFieldInvalid(key, value, description) {
          ...
          if (key && gaFieldSet[key] !== false) {
            ...
            if (/-phone-send$/.test(name)) {
              ...
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  remainingAttemptsCount ? gaPush(_category, "telegram_push - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount, " - reason: ").concat(description)) : gaPush(_category, "telegram_push - form - phone_telegram_push - reason: ".concat(description));
                } else {
                  remainingAttemptsCount ? gaPush(_category, "sms_code - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount, " - reason: ").concat(description)) : gaPush(_category, "sms_code - form - phone_sms_code - reason: ".concat(description));
                }
              } else {
        ...
        var handle_form = function handle_form() {
            ...
            $__default["default"].ajax({
              ...
              error: function error(xhr, resp, text) {
                ...
                if (/-reg$/.test(path)) {
                  ...
                  if (preferredMethod) {
                    if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                      remainingAttemptsCount ? gaPush('dl_qr_phone_process', "telegram_push - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount, " - reason: technical")) : gaPush('dl_qr_phone_process', "telegram_push - form - phone_telegram_push - reason: ".concat(description));
                    } else {
                      remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount, " - reason: technical")) : gaPush('dl_qr_phone_process', "sms_code - form - phone_sms_code - reason: technical");
                    }
                  } else {
              ...
              function submissionSuccess(result) {
                ...
                if (name.includes('phone-send')) {
                  ...
                  if (remainingAttemptsCount) {
                    gaPush(_category8, action + ' - attempts_left: ' + remainingAttemptsCount);
                  } else {
          ...
          function onFormSubmit(part) {
            ...
            validateAllFields(function () {
              ...
              if (/-reg$/.test(path)) {
                ...
                if (preferredMethod) {
                  if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                    remainingAttemptsCount ? gaPush(_category11, "send - telegram_push - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount)) : gaPush(_category11, "send - telegram_push - form - phone_telegram_push");
                  } else {
                    remainingAttemptsCount ? gaPush(_category11, "send - sms_code - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount)) : gaPush(_category11, "send - sms_code - form - phone_sms_code");
                  }
                } else {
          ...
          container.find(".ube-trigger-event").off("click").on("click", function (e) {
            ...
            if (event == "resendCode" || event == "resendPhoneCode" || event == "resendEmailCode") {
              if (preferredMethod) {
                if (sessionStorage.getItem('phoneSendMethod') === 'telegram') {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "telegram_push - send_again - form - phone_telegram_push - attempts_left: ".concat(remainingAttemptsCount)) : gaPush('dl_qr_phone_process', "telegram_push - send_again - form - phone_telegram_push");
                } else {
                  remainingAttemptsCount ? gaPush('dl_qr_phone_process', "sms_code - send_again - form - phone_sms_code - attempts_left: ".concat(remainingAttemptsCount)) : gaPush('dl_qr_phone_process', "sms_code - send_again - form - phone_sms_code");
                }
              }
              $__default["default"].ajax({
